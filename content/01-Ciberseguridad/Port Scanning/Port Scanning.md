...
|--------------- |--------------------------------------------------------------- |
|**[[NMAP|Nmap]]**        |Herramienta más usada. Potente, versátil, con motor de scripts. |
...
### Posibles resultados del escaneo
...
### Medidas defensivas contra escaneo de puertos
...
2. **IDS/IPS (Intrusion Detection/Prevention Systems)**:
    - Herramientas como [[SNORT|Snort]] o [[suricata|Suricata]] pueden detectar escaneos SYN, NULL, XMAS…
3. **[[Port Knocking|Port knocking]] / servicios detrás de VPN**:
...
### Sintaxis básica para escaneo de puertos con Netcat
