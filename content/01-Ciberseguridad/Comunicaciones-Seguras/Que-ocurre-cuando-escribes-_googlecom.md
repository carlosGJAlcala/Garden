---
title: "Que Ocurre Cuando Escribes _Googlecom"
date: 2026-01-26
tags:
  - ciberseguridad
...
Este repositorio es un intento de responder a la antigua pregunta "¿Qué ocurre cuando escribes _google.com_ en tu la barra de direcciones de tu navegador y pulsas _Enter_?"
...
Este es un proceso colaborativo, ¡así que investiga sobre la sección que más te guste y ayúdanos! Hay muchísimos detalles faltantes, ¡están esperando a que los añadas! ¡Envíanos un _pull request_, por favor!

Este trabajo está licenciado bajo la licencia [Creative Commons Zero](https://creativecommons.org/publicdomain/zero/1.0/).

También puedes leerlo en [简体中文](https://github.com/skyline75489/what-happens-when-zh_CN) (chino simplificado), [日本語](https://github.com/tettttsuo/what-happens-when-JA) (japonés) y [한국어](https://github.com/SantonyChoi/what-happens-when-KR) (koreano). También, por supuesto, la versión original de ["What happens when..."](https://github.com/alex/what-happens-when) en inglés.

## Tabla de contenidos


> **Relacionado**: [[01-Ciberseguridad/Herramientas/IDOR|IDOR]]. [[01-Ciberseguridad/Herramientas/Reconocimiento/FOCA|FOCA]]. [[07-Investigacion/Cuantica/bibliografia/biblio|biblio]]. [[00-Inicio/HOME|HOME]]. [[02-Ciencias-Computacion/Redes/Nginx|Nginx]].

[](https://github.com/gonzaleztroyano/what-happens-when-ES#tabla-de-contenidos)

- [La tecla "g" es presionada](https://github.com/gonzaleztroyano/what-happens-when-ES#la-tecla-g-es-presionada)
- [La tecla "enter" toca fondo](https://github.com/gonzaleztroyano/what-happens-when-ES#la-tecla-enter-toca-fondo)
- [Lanzamiento de interrupciones [NO para teclados USB]](https://github.com/gonzaleztroyano/what-happens-when-ES#lanzamiento-de-interrupciones-no-para-teclados-usb)
- [(En Windows) El mensaje `WM_KEYDOWN` es enviado a la aplicación](https://github.com/gonzaleztroyano/what-happens-when-ES#en-windows-el-mensaje-wm-keydown-es-enviado-a-la-aplicacion)
- [(En OS X) El NSEvent `KeyDown` NSEvent es enviado a la apliacación](https://github.com/gonzaleztroyano/what-happens-when-ES#en-os-x-el-nsevent-keydown-nsevent-es-enviado-a-la-apliacacion)
- [(En GNU/Linux) El servdor Xorg en escucha de "keycodes"](https://github.com/gonzaleztroyano/what-happens-when-ES#en-gnu-linux-el-servdor-xorg-en-escucha-de-keycodes)
- [Parsear la URL](https://github.com/gonzaleztroyano/what-happens-when-ES#parsear-la-url)
- [¿Es una URL o un término de búsqueda?](https://github.com/gonzaleztroyano/what-happens-when-ES#es-una-url-o-un-termino-de-busqueda)
- [Convertir caracteres no ASCII en el nombre de dominio](https://github.com/gonzaleztroyano/what-happens-when-ES#convertir-caracteres-no-ascii-en-el-nombre-de-dominio)
- [Comprobar la lista HSTS](https://github.com/gonzaleztroyano/what-happens-when-ES#comprobar-la-lista-hsts)
- [Búsqueda DNS](https://github.com/gonzaleztroyano/what-happens-when-ES#busqueda-dns)
- [Proceso ARP](https://github.com/gonzaleztroyano/what-happens-when-ES#proceso-arp)
- [Continúa proceso DNS](https://github.com/gonzaleztroyano/what-happens-when-ES#continua-proceso-dns)
- [Abrir un socket](https://github.com/gonzaleztroyano/what-happens-when-ES#abrir-un-socket)
- [Handshake TLS](https://github.com/gonzaleztroyano/what-happens-when-ES#handshake-tls)
- [Si un paquete se pierde](https://github.com/gonzaleztroyano/what-happens-when-ES#si-un-paquete-se-pierde)
- [Protocolo HTTP](https://github.com/gonzaleztroyano/what-happens-when-ES#protocolo-http)
- [Manejo de peticiones HTTP en servidor](https://github.com/gonzaleztroyano/what-happens-when-ES#manejo-de-peticiones-http-en-servidor)
- [El trabajo del navegador](https://github.com/gonzaleztroyano/what-happens-when-ES#el-trabajo-del-navegador)
- [Navegador](https://github.com/gonzaleztroyano/what-happens-when-ES#navegador)
- [Análisis de HTML](https://github.com/gonzaleztroyano/what-happens-when-ES#analisis-de-html)
- [Interpretación de CSS](https://github.com/gonzaleztroyano/what-happens-when-ES#interpretacion-de-css)
- [Renderización de la página](https://github.com/gonzaleztroyano/what-happens-when-ES#renderizacion-de-la-pagina)
- [Rendización GPU](https://github.com/gonzaleztroyano/what-happens-when-ES#rendizacion-gpu)
- [Servidor de ventanas](https://github.com/gonzaleztroyano/what-happens-when-ES#servidor-de-ventanas)
- [Post-procesado y ejecuciones a causa del usuario](https://github.com/gonzaleztroyano/what-happens-when-ES#post-procesado-y-ejecuciones-a-causa-del-usuario)

### La tecla "g" es presionada

[](https://github.com/gonzaleztroyano/what-happens-when-ES#la-tecla-g-es-presionada)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#la-tecla-enter-toca-fondo)
...
_En el caso de un teclado Bluetooth:_
...
- Esos paquetes son enviados por una señal eléctrica diferencial a través de los pines D+ y D+ (los dos del centro del conector) a un máximo de 1.5Mb/s. Como dispositivo HID (_Human Digital Interface_, Interfaz Digital Humana) es siempre declarado como un "dispositivo de baja velocidad" (complimiento del protocolo USB 2.0).
- Esta señal en serie es después decodificado en el equipo USB al que está conectado el teclado, e interpretado por el driver _Human Interface Device_ (HID) instalado en el equipo. El valor de la tecla es transmido a la capa de absracción hardware del sistema operativo.

_En el caso de teclados virtuales (como en dispositivos con pantallas táctiles):_
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#lanzamiento-de-interrupciones-no-para-teclados-usb)

El teclado envía señales a su _interrupt request line (IRQ)_, que es mapeada a un `vector de interrupción` (integral, _integer_) por el controlador de interrupciones. La CPU usa la `Interrupt Descriptor Table` (IDT) para mapear el vector de interrupción hacia las funciones (`manejadores de interrupciones`) que son proporcionados por el kernel. Cuando una interrupción es generada, la CPU busca en la IDT el vector de interrupción y ejecuta el manejador apropiado. Por lo tanto, se ingresa al kernel.

### (En Windows) El mensaje `WM_KEYDOWN` es enviado a la aplicación

[](https://github.com/gonzaleztroyano/what-happens-when-ES#en-windows-el-mensaje-wm_keydown-es-enviado-a-la-aplicaci%C3%B3n)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#en-os-x-el-nsevent-keydown-nsevent-es-enviado-a-la-apliacaci%C3%B3n)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#en-gnulinux-el-servdor-xorg-en-escucha-de-keycodes)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#parsear-la-url)

- El navegador tiene en este momento la siguiente información contenida en la URL (Uniform Resource Locator, _Localizador de recursos uniforme_):
...
[![Esquema de parseo de una URL](https://camo.githubusercontent.)](https://camo.githubusercontent.)

### ¿Es una URL o un término de búsqueda?

[](https://github.com/gonzaleztroyano/what-happens-when-ES#es-una-url-o-un-t%C3%A9rmino-de-b%C3%BAsqueda)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#convertir-caracteres-no-ascii-en-el-nombre-de-dominio)

- El navegador comprueba el nombre de dominio en busca de caracteres que no son `a-z`, `A-Z`, `0-9`, `-`, o `.`.
- Puesto que el nombre de dominio es `google.com` no habrá caracteres especiales fuera de los arriba indicados. Si los hubiera, el navegador aplicaría la codificación [Punycode](https://en.wikipedia.org/wiki/Punycode) a la parte del dominio de la URL.

### Comprobar la lista HSTS

[](https://github.com/gonzaleztroyano/what-happens-when-ES#comprobar-la-lista-hsts)
...
- `gethostbyname` comprueba si el nombre de dominio puede ser resuelto buscando en el archivo `hosts` local (cuya localización [puede variar por OS](https://en.wikipedia.org/wiki/Hosts_%28file%29#Location_in_the_file_system)) antes de intentar su resolución mediante DNS.
- Si `gethostbyname` no tiene la respuesta en caché o no la ha podido encontrar en el archivo `hosts`, realiza una petición al servidor DNS configurado en los ajustes de red. Normalmente, es el _router_ de nuestro operador o su servidor de cacheo DNS. En Windows usará un algoritmo que determina qué servidor DNS consultar primera para resolver el nombre de dominio. (Véase [este enlace]([http://technet.microsoft.com/en-us/library/dd197552(WS.10).aspx](http://technet.microsoft.com/en-us/library/dd197552\(WS.10\).aspx)))
...
- El servidor DNS solicitante utilizará esta información para llegar al servidor DNS "real" de google.com (el que posee la SOA del dominio) y pide una resolución A (o AAAA si es IPv6) con "[www.google.com](http://www.google.com/)". como la solicitud.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#proceso-arp)
...
- La librería de red enbía una solicitud ARP de capa 2 (capa de enlace de datos en el [modelo OSI](https://es.wikipedia.org/wiki/Modelo_OSI)):
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#contin%C3%BAa-proceso-dns)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#abrir-un-socket)
...
- [Datos móviles](https://en.wikipedia.org/wiki/Cellular_data_communication_protocol)

Para la mayoría de las conexiones a Internet domésticas o de pequeñas empresas, el paquete pasará desde su equipo, posiblemente a través de una red local, y luego a través de un módem (MOdulator/DEModulator) que convierte los 1 y 0 digitales en una señal analógica adecuada para la transmisión por teléfono, cable, o conexiones de telefonía inalámbrica. En el otro extremo de la conexión hay otro módem que vuelve a convertir la señal analógica en datos digitales para ser procesados por el siguiente [nodo de la red](https://en.wikipedia.org/wiki/Computer_network#Network_nodes) donde se analizarán más a fondo las direcciones de origen y destino.

La mayoría de las empresas más grandes y algunas conexiones residenciales más nuevas tendrán conexiones de fibra o Ethernet directa, en cuyo caso los datos permanecen digitales y pasan directamente al siguiente [nodo de la red](https://en.wikipedia.org/wiki/Computer_network#Network_nodes) para su procesamiento. En España, al menos en las áreas metropolitanas, es común la conexión mediante FTTH (Fiber to the home).
...
- El cliente reconoce la conexión enviando un paquete:
    ...
    - Aumenta el número de _acknowledgment_ del receptor.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#handshake-tls)

El protocolo TSL es el sucesor de SSL, que provee un mecanismo seguro para autenticación utilizando certificados x509. También provee un canal de comunicación bidireccional entre dos partes, como un navegador y un cliente web, para establecer los detalles de su comunicación. Un "TLS Handshake", que se podría traducir como "apretón de manos TLS", ocurre cuando usuario accede a un sitio a través de HTTPS (HTTP Seguro. Muy por encima, HTTP es el protocolo sobre el que se comunican las páginas web). El navegador comienza a consultar el servidor de origen del sitio web, también ocurre cada vez que cualquier otra comunicación utiliza HTTPS, incluidas las llamadas API y DNS over HTTPS/DNS over TLS.
...
y la firma digital de la autoridad certificadora SSL. * Generar claves de sesión para usar encriptación simétrica (más eficiente y rápida que la asimétrica) después de completar el _TLS Handshake_.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#si-un-paquete-se-pierde)

A veces, debido a la congestión de la red o conexiones de hardware inestables, los paquetes TLS se descartarán antes de que lleguen a su destino final. El remitente entonces tiene que decidir cómo reaccionar. El algoritmo para esto se llama [control de congestión TCP](https://en.wikipedia.org/wiki/TCP_congestion_control). Esto varía según el remitente; los algoritmos más comunes son [cubic](https://en.wikipedia.org/wiki/CUBIC_TCP) en los sistemas operativos más nuevos y [New Reno](https://en.wikipedia.org/wiki/TCP_congestion_control#TCP_New_Reno) en casi todos los demás.

- El cliente elige una [congestion window](https://en.wikipedia.org/wiki/TCP_congestion_control#Congestion_window) ("ventana de congestión", en castellano) basada en el [maximum segment size](https://en.wikipedia.org/wiki/Maximum_segment_size) (MSS, tamaño máximo del segmento) de la conexión.
- Por cada paquete reconocido, la ventana se duplica en tamaño hasta que alcanza el 'umbral de inicio lento', _slow-start threshold_. En algunas implementaciones, este umbral es adaptativo.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#protocolo-http)
...
Este protocolo, SPDY fue un intento de Google para mejorar la navegación web. Fue un protocolo experimental que quedó [descontinuado](https://blog.chromium.org/2016/02/transitioning-from-spdy-to-http2.html) en favor de HTTP/2.
...
Seguido de un solo salto de línea, envía un _payload_ del contenido HTML de `www.google.com`. Luego, el servidor puede cerrar la conexión o, si los encabezados enviados por el cliente lo solicitaron, mantener la conexión abierta para reutilizarla para futuras solicitudes.
...
> 304 Not Modified [cabeceras de respuesta]
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#manejo-de-peticiones-http-en-servidor)
...
- El servidor desglosa la solicitud en los siguientes parámetros:
    ...
    - Método de petición HTTP (que puede ser `GET`, `HEAD`, `POST`, `PUT`, `PATCH`, `DELETE`, `CONNECT`, `OPTIONS`, o `TRACE`). En el caso de una URL ingresada directamente en la barra de direcciones, el método será `GET`.
    - Dominio, en este caso google.com.
    - Página o ruta solicitada. En este caso, _/_ (puesto que no se solicitó una ruta/página específica, / es la ruta por defecto).
...
- Si el servidor tiene instalado un módulo de reescritura (como _mod_rewrite_ para Apache o _URL Rewrite_ para IIS), intenta hacer coincidir la solicitud con una de las reglas configuradas. Si se encuentra una regla coincidente, el servidor usa esa regla para reescribir la solicitud.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#el-trabajo-del-navegador)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#navegador)
...
Las interfaces de usuario del navegador tienen mucho en común entre sí. Los elementos comunes de la interfaz de usuario son:
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#an%C3%A1lisis-de-html)
...
El árbol de salida (el "_parse tree_") es un árbol de elementos nodos y atributos DOM. DOM es la abreviatura de _Document Object Model_, Modelo de Objetos de Documento.
...
- El proceso de análisis es reentrante. Para otros idiomas, la fuente no cambia durante el análisis, pero en HTML, el código dinámico (como los elementos de _scripts_ que contienen llamadas document.write()) pueden agregar tokens adicionales, por lo que el proceso de análisis en realidad modifica la entrada.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#interpretaci%C3%B3n-de-css)

- Analizar archivos CSS, contenidos de etiquetas `<style>` y valores de atributo `style` utilizando la ["Sintaxis y léxico CSS"](http://www.w3.org/TR/CSS2/grammar.html)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#renderizaci%C3%B3n-de-la-p%C3%A1gina)

- Se crea un "_Frame Tree_", "Árbol de marcos" en castellano, o "_Render Tree_", 'Árbol de procesamiento' en castellano, recorriendo los nodos DOM y calculando los valores de estilo CSS para cada nodo.
- Ce calcula el ancho preferido de cada nodo en el "_Frame Tree_" de abajo hacia arriba sumando el ancho preferido de los nodos secundarios y los márgenes horizontales (_margins_), bordes (_borders_) y relleno (_padding_) del nodo.
...
- Se toman pasos más complicados cuando los elementos están "flotados" (`float`), posicionados `absolutamente` o `relativamente`, u otras características complejas son utilizados. Consulte [https://dev.w3.org/csswg/css2/](https://dev.w3.org/csswg/css2/) y [https://www.w3.org/Style/CSS/current-work](https://www.w3.org/Style/CSS/current-work) para obtener más detalles.
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#rendizaci%C3%B3n-gpu)
...
[](https://github.com/gonzaleztroyano/what-happens-when-ES#servidor-de-ventanas)

### Post-procesado y ejecuciones a causa del usuario

[](https://github.com/gonzaleztroyano/what-happens-when-ES#post-procesado-y-ejecuciones-a-causa-del-usuario)
